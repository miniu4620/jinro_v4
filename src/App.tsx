...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-800 antialiased font-['Pretendard',sans-serif]">
      {/* Top Navbar */}
      <Navbar
      ...
      <footer className="h-14 sm:h-12 bg-white border-t border-slate-200 px-4 sm:px-8 flex flex-col sm:flex-row items-center justify-between text-[10px] sm:text-[11px] text-slate-400 font-medium uppercase tracking-[0.15em] py-2 sm:py-0 gap-1 sm:gap-0 text-center sm:text-left">
        <span>2026 은평대전 전공박람회 (Eunpyeong Career Fair)</span>
